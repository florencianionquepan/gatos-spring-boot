...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        ...
        http.sessionManagement(httpSecuritySessionManagementConfigurer -> {
                ...
                .csrf((csrf) -> csrf.csrfTokenRequestHandler(requestHandler).ignoringRequestMatchers("/gatos/**","/personas","/cuotas","/generic/**","/usuarios/**","/cloudinary/**","/ficha/**")
                ...
                .authorizeHttpRequests((requests)->requests
                        ...
                        .requestMatchers("/gatos/**","/personas","/cuotas","/generic/**","/usuarios/**","/cloudinary/**","/ficha/**").permitAll())
